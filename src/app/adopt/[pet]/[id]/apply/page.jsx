...
const Apply = () => {
  ...
  return (
    <div className={`${styles.apply_wrapper}`}>
      ...
      <p className={`${styles.apply_sub}`}>
        Thank you for considering adoption at Wonder Pets. We are excited that
        you are one step closer on giving a loving home to your new best friend.
      </p>
      ...
      <form ref={formRef} className={`${styles.form}`} onSubmit={handleSubmit}>
        ...
        {/* eligibility */}
        <label for="eligibility" className={`form-label`}>
          Eligibility<span className={`${styles.required}`}>*</span>
        </label>
        <textarea
          name="eligibility"
          id="eligibility"
          cols=""
          rows="5"
          placeholder="Please state your reason why you want to adopt and take care of our pet"
          className={`form-control`}
          required
        ></textarea>

        {/* responsibility */}
        <label for="responsibility" className={`form-label`}>
        ...
        <textarea
          ...
          cols=""
          rows="3"
          placeholder="Who will take care of the pet besides you?"
          className={`form-control`}
          required
        ></textarea>

        {/* environment */}
        <label for="environment" className={`form-label`}>
        ...
        <textarea
          ...
          cols=""
          rows="5"
          placeholder="Please describe the new environment the pet will live in"
          className={`form-control`}
          required
        ></textarea>

        <label for="image" className={`form-label`}>
          To verify your identity, please take a selfie picture together with
          your government valid id
        ...
        <div id="imageHelp" className={`form-text`}>
          We value your privacy. We'll never share your image with anyone else.
        </div>
